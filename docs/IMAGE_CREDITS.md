...
|--------|---------|-------------------|-------------|
| Planet MP3 original icons | Original work in this repo | Yes | Planet MP3 |
...
| Slot | File | Notes |
|------|------|--------|
| Idle hero (no sleeve yet) | `src/assets/editorial/hero-idle.png` | White iPod with click wheel |
