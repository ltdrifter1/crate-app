  ...
  return (
    ...
    >
      <div aria-hidden="true" style={{
        ...
        backgroundImage: "repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(216,223,232,0.35) 3px)",
      }} />
      ...
      <div style={{
        ...
        borderRadius: 28,
        background: `
          linear-gradient(165deg, rgba(42,47,55,0.85) 0%, rgba(180,187,198,0.55) 100%)
        `,
