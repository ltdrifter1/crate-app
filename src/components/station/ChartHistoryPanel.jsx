        ...
        return (
          <button
            ...
            style={{
              ...
              cursor: "pointer",
              boxShadow: active
                ? "inset 0 1px 0 rgba(255,255,255,0.28), 0 3px 8px rgba(30,111,232,0.22)"
                : "none",
  ...
  return (
    <article
      ...
      style={{
        ...
        overflow: "hidden",
        border: active
          ? "1px solid rgba(30,111,232,0.4)"
          : "1px solid rgba(232,234,238,0.12)",
        background: `
          radial-gradient(120% 80% at 0% 0%, rgba(30,111,232,0.12) 0%, transparent 46%),
